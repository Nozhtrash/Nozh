...
public class VitalsGraphWidget implements Drawable, Element, Selectable {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Note: You might need to update VitalsRecorder to expose
        // `getFrameTimeHistory()`
        ...
        // 4. Render Graph
        // We use the Tessellator directly for lines because DrawContext is limited for
        // arbitrary shapes
        ...
        context.drawText(net.minecraft.client.MinecraftClient.getInstance().textRenderer, fpsText, x + 4, y + 4,
                0xFFFFFF, true);
    }
