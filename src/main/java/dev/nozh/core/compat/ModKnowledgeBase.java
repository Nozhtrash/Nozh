...
public final class ModKnowledgeBase {
    ...
    private static Map<String, ModInfo> createKnownMods() {
        ...
        mods.put("smoothboot-fabric", new ModInfo("smoothboot-fabric", "Smooth Boot", ModCategory.OPTIMIZATION,
                Set.of(), Set.of(),
                Set.of(), PerformanceImpact.POSITIVE, "https://modrinth.com/mod/smoothboot-fabric", false));
        ...
        mods.put("immediatelyfast", new ModInfo("immediatelyfast", "ImmediatelyFast", ModCategory.OPTIMIZATION,
                ...
                Set.of(), PerformanceImpact.POSITIVE, "https://modrinth.com/mod/immediatelyfast", false));
        ...
        mods.put("reeses-sodium-options", new ModInfo("reeses-sodium-options", "Reese's Sodium Options", ModCategory.OPTIMIZATION,
                Set.of(), Set.of("sodium"),
                Set.of(), PerformanceImpact.NEUTRAL, "https://modrinth.com/mod/reeses-sodium-options", true));
        ...
        mods.put("cull-less-leaves", new ModInfo("cull-less-leaves", "Cull Less Leaves", ModCategory.ENTITIES,
                Set.of(), Set.of("sodium"),
                Set.of(), PerformanceImpact.POSITIVE, "https://modrinth.com/mod/cull-less-leaves", false));

        mods.put("enhancedblockentities", new ModInfo("enhancedblockentities", "Enhanced Block Entities", ModCategory.ENTITIES,
                Set.of(), Set.of("sodium"),
                Set.of(), PerformanceImpact.POSITIVE, "https://modrinth.com/mod/ebe", false));
        ...
        mods.put("distanthorizons", new ModInfo("distanthorizons", "Distant Horizons", ModCategory.WORLD_GEN,
                Set.of(), Set.of("sodium"),
                Set.of(), PerformanceImpact.NEGATIVE, "https://modrinth.com/mod/distanthorizons", true));
        ...
        mods.put("lambdynamiclights", new ModInfo("lambdynamiclights", "LambDynamicLights", ModCategory.GRAPHICS,
                Set.of(), Set.of("sodium"),
                Set.of(), PerformanceImpact.NEGATIVE, "https://modrinth.com/mod/lambdynamiclights", false));
        ...
        mods.put("xaeros-worldmap", new ModInfo("xaeros-worldmap", "Xaero's World Map", ModCategory.UTILITIES,
                ...
                Set.of(), PerformanceImpact.NEUTRAL, "https://modrinth.com/mod/xaeros-world-map", false));
        ...
        mods.put("modern_industrialization", new ModInfo("modern_industrialization", "Modern Industrialization", ModCategory.CONTENT,
                Set.of(), Set.of(),
                Set.of(), PerformanceImpact.NEGATIVE, "https://modrinth.com/mod/modern-industrialization", false));
        ...
        mods.put("farmers-delight-fabric", new ModInfo("farmers-delight-fabric", "Farmer's Delight", ModCategory.CONTENT,
                Set.of(), Set.of(),
                Set.of(), PerformanceImpact.NEUTRAL, "https://modrinth.com/mod/farmers-delight-fabric", false));
        ...
        mods.put("architectury-api", new ModInfo("architectury-api", "Architectury API", ModCategory.LIBRARY,
                Set.of(), Set.of(),
                Set.of(), PerformanceImpact.NEUTRAL, "https://modrinth.com/mod/architectury-api", false));
