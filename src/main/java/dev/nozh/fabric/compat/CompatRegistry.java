...
public final class CompatRegistry {
        ...
        public CompatRegistry() {
                register(new CompatModule("sodium", "Sodium",
                                EnumSet.of(CapabilityId.CLOUDS, CapabilityId.VSYNC, CapabilityId.FOG,
                                                CapabilityId.BIOME_BLEND,
                                                CapabilityId.ENTITY_DISTANCE, CapabilityId.RENDER_DISTANCE,
                                                CapabilityId.MIPMAP_LEVEL,
                                                CapabilityId.SMOOTH_LIGHTING, CapabilityId.PARTICLES,
                ...
                register(new CompatModule("nvidium", "Nvidium",
                                EnumSet.of(CapabilityId.RENDER_DISTANCE, CapabilityId.VSYNC,
                ...
                register(new CompatModule("gamma-utils", "Gamma Utils",
                                EnumSet.of(CapabilityId.GRAPHICS_MODE)));
                register(new CompatModule("fullbright", "Fullbright",
                                EnumSet.of(CapabilityId.GRAPHICS_MODE)));
                register(new CompatModule("distanthorizons", "Distant Horizons", // Alternate ID
                                EnumSet.of(CapabilityId.RENDER_DISTANCE, CapabilityId.FOG)));
                register(new CompatModule("cubes-without-borders", "Cubes Without Borders",
                                EnumSet.of(CapabilityId.GRAPHICS_MODE)));
        ...
        public boolean isActionPermitted(CapabilityId capability) {
                return modules.values().stream()
                                .filter(module -> actionRegistry.isPermitted(module.modId(), capability)
                                                && isLoaded(module.modId()))
        ...
        private void syncStewardshipDeclarations() {
                for (CompatModule module : modules.values()) {
                        ...
                        StewardshipDeclaration.Builder builder = StewardshipDeclaration
                                        .builder(module.modId(), module.displayName())
