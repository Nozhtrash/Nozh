...
public class NozhMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Safety: Crash Guard - Check BEFORE governor init
        // Checks for boot loops and enables Safe Mode if necessary
        boolean forceSafeMode = false;
        try {
            dev.nozh.core.safety.CrashSafeGuard crashGuard = new dev.nozh.core.safety.CrashSafeGuard(
        ...
        // Initialize governor ONCE with correct safe mode parameter
        ...
        if (!forceSafeMode) {
            dev.nozh.core.tuning.ModpackTuner.tune();
        }
